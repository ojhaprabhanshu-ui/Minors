...
const Page_1 = () => {
  return (
    <section className="relative w-full bg-slate-50/50 text-slate-900 flex flex-col items-center pb-20 sm:pb-24 px-5 sm:px-8 lg:px-10 overflow-hidden selection:bg-blue-500 selection:text-white">
      ...
      {/* Main Hero Container */}
      <div className="relative max-w-5xl w-full min-h-[calc(100svh-72px)] py-16 sm:py-20 flex flex-col items-center justify-center text-center gap-8 sm:gap-10">
        ...
        {/* Main Headline */}
        <h1 className="text-6xl sm:text-7xl lg:text-8xl font-black tracking-tight leading-[1.06] text-slate-900 max-w-6xl">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-5 w-full sm:w-auto">
          <button className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold text-lg px-8 py-3.5 rounded-full shadow-xl shadow-blue-500/25 active:scale-95 hover:-translate-y-0.5 transition-all cursor-pointer">
            Create Resume Now
            <ArrowRight className="w-6 h-6" />
          </button>
          
          <button className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white hover:bg-slate-100 text-slate-700 border border-slate-200/80 font-medium text-lg px-8 py-3.5 rounded-full active:scale-95 transition-all shadow-sm cursor-pointer">
            Check ATS Score
          </button>
        </div>

        {/* Feature Highlights Strip */}
        <div className="pt-5 grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-5 w-full max-w-5xl">
          <div className="flex items-center justify-center gap-2.5 bg-white/80 backdrop-blur-sm px-4 py-3.5 rounded-2xl border border-slate-200/60 shadow-xs">
            <CheckCircle2 className="w-5 h-5 text-blue-600 shrink-0" />
            <span className="text-sm sm:text-base font-medium text-slate-700">Real-time ATS Score</span>
          </div>
          
          <div className="flex items-center justify-center gap-2.5 bg-white/80 backdrop-blur-sm px-4 py-3.5 rounded-2xl border border-slate-200/60 shadow-xs">
            <Zap className="w-5 h-5 text-blue-600 shrink-0" />
            <span className="text-sm sm:text-base font-medium text-slate-700">One-Click AI Writer</span>
          </div>

          <div className="flex items-center justify-center gap-2.5 bg-white/80 backdrop-blur-sm px-4 py-3.5 rounded-2xl border border-slate-200/60 shadow-xs">
            <ShieldCheck className="w-5 h-5 text-blue-600 shrink-0" />
            <span className="text-sm sm:text-base font-medium text-slate-700">Recruiter Approved</span>
          </div>

          <div className="flex items-center justify-center gap-2.5 bg-white/80 backdrop-blur-sm px-4 py-3.5 rounded-2xl border border-slate-200/60 shadow-xs">
            <Sparkles className="w-5 h-5 text-blue-600 shrink-0" />
            <span className="text-sm sm:text-base font-medium text-slate-700">Smart Job Matching</span>
          </div>
        </div>
